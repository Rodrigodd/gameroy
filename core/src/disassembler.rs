...
pub fn disassembly_opcode(
    ...
    match op[0] {
        ...
        0x07 => write!(w, "RLCA "),
        0x08 => write!(w, "LD   ({}), SP ",label( u16::from_le_bytes([op[1], op[2]]))),
        ...
        0xe9 => write!(w, "JP   (HL) "),
        0xea => write!(w, "LD   ({}), A ",label( u16::from_le_bytes([op[1], op[2]]))),
        0xeb => write!(w, "     "),
        0xec => write!(w, "     "),
        0xed => write!(w, "     "),
        ...
        0xfa => write!(w, "LD   A, ({}) ",label( u16::from_le_bytes([op[1], op[2]]))),
        0xfb => write!(w, "EI   "),
        0xfc => write!(w, "     "),
        0xfd => write!(w, "     "),
